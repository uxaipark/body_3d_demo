...
export const sleepChannels={cap:{width:1,unit:'pF'},ecg:{width:1,unit:'mV'},acc:{width:3,unit:'m/s2'},breathAudio:{width:1,unit:'rms'},snore:{width:1,unit:'probability'},camera:{width:1,unit:'motion'},radar:{width:4,unit:'mm'},airflow:{width:1,unit:'L/s'}};
...
export class SleepGenerator{
 ...
 step(dt,settings=sleepDefaults,pose={roll:0,motion:0},geometry=defaultPatchGeometry){
  ...
  // the local electrode interface offset. The ECG lead is E+ minus E−; the central CAP pad is the reference.
